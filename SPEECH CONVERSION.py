...
#dictinary for all laguanges in Google 
language={}
...
if 'hi' in rec1.recognize_google(audio):     #for converting our speech into text
    ...
    speak_lan=input("Please Enter the language you want to speak: ")
    from_lan=get_key(language,speak_lan)
    print(from_lan)
    hear_lan=input("Please Enter the language you want to hear: ")
